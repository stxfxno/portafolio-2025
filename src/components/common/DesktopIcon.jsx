// src/components/common/DesktopIcon.jsx
import React from 'react';

const DesktopIcon = ({ icon, title, onClick }) => {
  return (
    <div 
      className="w-20 flex flex-col items-center p-2 rounded hover:bg-gray-800 hover:bg-opacity-40 cursor-pointer transition-colors"
      onClick={onClick}
    >
      <div className="w-12 h-12 flex items-center justify-center bg-gray-800 rounded-lg mb-1 shadow-lg">
