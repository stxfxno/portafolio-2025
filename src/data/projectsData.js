  ...
  deploy:
    ...
    - name: Deploy to AWS
      ...
      env:
        ...
        AWS_ACCESS_KEY_ID: "mi-access-key-id"
        AWS_SECRET_ACCESS_KEY: "mi-secret-access-key"
    ...
    - name: Invalidate CloudFront
      ...
      env:
        DISTRIBUTION: "mi-distribution-id"
        PATHS: '/*'
        AWS_REGION: 'us-west-2'
        AWS_ACCESS_KEY_ID: "mi-access-key-id"
        AWS_SECRET_ACCESS_KEY: "mi-secret-access-key"`,
...
export default cartSlice.reducer;`
  ...
  // Se pueden agregar más proyectos inspirados en el CV de Michael Carmelino
  {
    id: 'listify-mp3',
    name: 'Listify MP3 Downloader',
    shortDescription: 'Herramienta Python para descargar listas de música desde YouTube',
    description: 'Aplicación que automatiza la descarga de música desde YouTube a partir de una lista de canciones en formato TXT.',
    year: 2024,
    status: 'completed',
    type: 'desktop',
    technologies: ['Python', 'YouTube API', 'PyTube'],
    repo: 'https://github.com/stxfxno/Listify',
    demo: null,
    image: '/assets/projects/listify.jpg',
    highlights: [
      'Procesamiento automatizado de listas de canciones',
      'Búsqueda inteligente en YouTube',
      'Descarga y organización de archivos MP3',
      'Gestión de errores y reintentos automáticos'
    ]
  },
  {
    id: 'myevent-backend',
    name: 'Backend para Plataforma de Eventos',
    shortDescription: 'API RESTful para gestión de eventos con Java y Spring Boot',
    description: 'Backend completo para una plataforma de gestión de eventos, con funcionalidades CRUD y autenticación de usuarios.',
    year: 2024,
    status: 'completed',
    type: 'web',
    technologies: ['Java', 'Spring Boot', 'MySQL', 'RESTful API'],
    repo: 'https://github.com/stxfxno/BackendOS_user/tree/main/MyEvent',
    demo: 'https://michael-carmelino-web.netlify.app/proyectos/myevent/',
    image: '/assets/projects/myevent.jpg',
    highlights: [
      'Implementación de endpoints RESTful para todas las operaciones CRUD',
